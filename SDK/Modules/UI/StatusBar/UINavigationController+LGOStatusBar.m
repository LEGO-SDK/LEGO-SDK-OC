...
- (void)lgo_setNeedsStatusBarAppearanceUpdate {
    ...
    if ([value isKindOfClass:[NSNumber class]]) {
        if (!((NSNumber *)value).boolValue) {
            [[UIApplication sharedApplication] setStatusBarStyle:[self.visibleViewController preferredStatusBarStyle]
                                                        animated:NO];
            [[UIApplication sharedApplication] setStatusBarHidden:[self.visibleViewController prefersStatusBarHidden]
